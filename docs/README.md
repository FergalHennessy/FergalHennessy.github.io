...
-feed
-tags
    plugin in _plugins for automatic tag generation and lookup of tagged pages, thanks to [this](https://www.untangled.dev/2020/06/02/tag-management-jekyll/) fantastic tutorial, TODO fix orphaned pages
